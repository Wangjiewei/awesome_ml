...
# Since 'ps_calc' features do not show any have zero relationship with other feature , We can delete them.
...
print get_missing_features(df_train)
print get_missing_features(df_test)
